...
class EstadioClasif
{
    ...
    */
     ...
     * Set servicioAt
     *
     * @param boolean $servicioAt
     * @return EstadioClasif
     */
    public function setServicioAt($servicioAt)
    {
        $this->servicioAt = $servicioAt;
     ...
     * @return boolean 
     */
    public function getServicioAt()
    {
        return $this->servicioAt;
    }

    /**
     * Set repuestoAt
     *
     * @param boolean $repuestoAt
     * @return EstadioClasif
     */
    public function setRepuestoAt($repuestoAt)
    {
        $this->repuestoAt = $repuestoAt;
     ...
     * @return boolean 
     */
    public function getRepuestoAt()
    {
        return $this->repuestoAt;
    }
}
